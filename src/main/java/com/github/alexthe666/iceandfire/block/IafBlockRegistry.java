...
public class IafBlockRegistry {
    ...
    public static final Block SILVER_BLOCK = new BlockGeneric(Material.METAL, "silver_block", "pickaxe", 2, 3.0F, 10.0F, SoundType.METAL);
    public static final Block SAPPHIRE_BLOCK = new BlockGeneric(Material.METAL, "sapphire_block", "pickaxe", 2, 3.0F, 10.0F, SoundType.METAL);
    public static final Block COPPER_BLOCK = new BlockGeneric(Material.METAL, "copper_block", "pickaxe", 0, 4.0F, 10.0F, SoundType.METAL);
    public static final Block AMYTHEST_BLOCK = new BlockGeneric(Material.METAL, "amythest_block", "pickaxe", 2, 5.0F, 15.0F, SoundType.METAL);
    ...
    public static final Block FROZEN_STONE = new BlockReturningState(Material.STONE, "frozen_stone", "pickaxe", 0, 1.5F, 10.0F, SoundType.GLASS, true, Blocks.STONE.defaultBlockState());
    public static final Block FROZEN_COBBLESTONE = new BlockReturningState(Material.STONE, "frozen_cobblestone", "pickaxe", 0, 2F, 10.0F, SoundType.GLASS, true, Blocks.COBBLESTONE.defaultBlockState());
    ...
    public static final Block CRACKLED_STONE = new BlockReturningState(Material.STONE, "crackled_stone", "pickaxe", 0, 1.5F, 10.0F, SoundType.STONE, Blocks.STONE.defaultBlockState());
    public static final Block CRACKLED_COBBLESTONE = new BlockReturningState(Material.STONE, "crackled_cobblestone", "pickaxe", 0, 2F, 10.0F, SoundType.STONE, Blocks.COBBLESTONE.defaultBlockState());
    ...
    public static final Block DREAD_STONE_BRICKS_SLAB = new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(10F, 10000F)).setRegistryName("iceandfire:dread_stone_slab");
