...
public class RenderPixieHouse<T extends TileEntityPixieHouse> extends BlockEntityRenderer<T> {
    ...
    public RenderPixieHouse(BlockEntityRenderDispatcher rendererDispatcherIn) {
