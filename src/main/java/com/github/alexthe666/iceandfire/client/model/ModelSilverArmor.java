...
public class ModelSilverArmor extends HumanoidModel {
    public ModelPart faceGuard;
    public ModelPart helmWingR;
    public ModelPart crest;
    public ModelPart helmWingL;
    public ModelPart robeLower;
    public ModelPart robeLowerBack;

    public ModelSilverArmor(float modelSize) {
        super(modelSize, 0, 64, 64);
        this.texWidth = 64;
        this.texHeight = 64;
        this.faceGuard = new ModelPart(this, 30, 47);
        ...
        this.robeLowerBack = new ModelPart(this, 4, 55);
        ...
        this.crest = new ModelPart(this, 18, 32);
        ...
        this.helmWingL = new ModelPart(this, 2, 37);
