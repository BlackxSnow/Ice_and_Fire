...
public class ModelSeaSerpentArmor extends HumanoidModel {
    public ModelPart headFin;
    public ModelPart headFin2;
    public ModelPart armFinR;
    public ModelPart shoulderR;
    public ModelPart legFinR;
    public ModelPart armFinL;
    public ModelPart shoulderL;
    public ModelPart legFinR_1;

    public ModelSeaSerpentArmor(float modelSize) {
        super(modelSize, 0, 64, 64);
        this.texWidth = 64;
        this.texHeight = 64;
        this.headFin2 = new ModelPart(this, 0, 32);
        ...
        this.armFinR = new ModelPart(this, 30, 32);
        ...
        this.headFin = new ModelPart(this, 0, 32);
        ...
        this.legFinR = new ModelPart(this, 45, 31);
