...
public class ModelDragonsteelIceArmor extends HumanoidModel {
    ...
    public ModelPart HornR6;
    public ModelPart HornL6;
    ...
    public ModelDragonsteelIceArmor(float modelSize) {
        ...
        this.HornL7 = new ModelPart(this, 25, 45);
        this.HornL7.setPos(0.0F, 0.0F, 4.3F);
        this.HornL7.addBox(-1.0F, -0.8F, 0.0F, 2, 2, 3, modelSize);
        this.setRotateAngle(HornL7, 0.12217304763960307F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(HornL2, -0.08726646259971647F, 0.0F, 0.0F);
        this.HornR6 = new ModelPart(this, 9, 38);
        this.HornR6.mirror = true;
        this.HornR6.setPos(-1.1F, -7.6F, -4.0F);
        this.HornR6.addBox(-1.0F, -0.8F, 0.0F, 2, 2, 5, modelSize);
        this.setRotateAngle(HornR6, 0.5126032013107347F, -0.13962634015954636F, 0.0F);
        ...
        this.HornR7 = new ModelPart(this, 25, 45);
        this.HornR7.mirror = true;
        this.HornR7.setPos(0.0F, 0.0F, 4.3F);
        this.HornR7.addBox(-1.0F, -0.8F, 0.0F, 2, 2, 3, modelSize);
        this.setRotateAngle(HornR7, 0.12217304763960307F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(HornR2, -0.08726646259971647F, 0.0F, 0.0F);
        ...
        this.HornL6 = new ModelPart(this, 9, 38);
        this.HornL6.setPos(1.1F, -7.6F, -4.0F);
        this.HornL6.addBox(-1.0F, -0.8F, 0.0F, 2, 2, 5, modelSize);
        this.setRotateAngle(HornL6, 0.5126032013107347F, 0.13962634015954636F, 0.0F);
        ...
        this.head.addChild(this.HornR6);
        ...
        this.head.addChild(this.HornL6);
