...
public class ParticleSirenMusic extends TextureSheetParticle {
    ...
    public ParticleSirenMusic(ClientLevel world, double x, double y, double z, double motX, double motY, double motZ, float size) {
        ...
        this.rCol = Math.max(0.0F, Mth.sin(((float)colorScale + 0.0F) * 6.2831855F) * 0.65F + 0.35F);
        this.gCol = Math.max(0.0F, Mth.sin(((float)colorScale + 0.33333334F) * 6.2831855F) * 0.65F + 0.35F);
        this.bCol = Math.max(0.0F, Mth.sin(((float)colorScale + 0.6666667F) * 6.2831855F) * 0.65F + 0.35F);
    }
