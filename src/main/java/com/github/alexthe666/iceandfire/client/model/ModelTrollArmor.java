...
public class ModelTrollArmor extends HumanoidModel {
    ...
    public ModelTrollArmor(float modelSize) {
        ...
        this.texWidth = 64;
        this.texHeight = 64;
        this.hornL = new ModelPart(this, 3, 41);
        ...
        this.hornL2 = new ModelPart(this, 15, 50);
        ...
        this.hornR = new ModelPart(this, 4, 41);
        ...
        this.hornR2 = new ModelPart(this, 15, 50);
