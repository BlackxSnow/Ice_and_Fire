...
public class ModelTideTrident extends ListModel {
    public ModelPart shaft;
    public ModelPart base;
    public ModelPart blade_B;
    public ModelPart blade_C;
    public ModelPart blade_A;
    public ModelPart fins;
    public ModelPart blade_C_2;
    public ModelPart blade_A_2;

    public ModelTideTrident() {
        this.texWidth = 64;
        this.texHeight = 32;
        this.fins = new ModelPart(this, 5, 12);
        this.fins.setPos(0.0F, 0.0F, 0.0F);
        this.fins.addBox(-5.5F, -1.0F, 0.0F, 11, 7, 0, 0.0F);
        this.blade_A_2 = new ModelPart(this, 28, 0);
        ...
        this.base = new ModelPart(this, 5, 5);
        ...
        this.blade_C_2 = new ModelPart(this, 28, 0);
