...
public class GuiMyrmexStaff extends Screen {
    ...
    protected void init() {
        ...
        populateRoomMap();
        this.addButton(new Button(i + 124, j + 15, 120, 20, ClientProxy.getReferedClientHive().reproduces ? new TranslatableComponent("myrmex.message.disablebreeding") : new TranslatableComponent("myrmex.message.enablebreeding"), (p_214132_1_) -> {
