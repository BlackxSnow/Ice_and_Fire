                ...
                if (itemstack.getItem() == IafItemRegistry.BESTIARY) {
                    ...
                    if (IceAndFire.PROXY.getRefrencedTE() instanceof TileEntityLectern) {
                        if(playerIn.level.isClientSide){
                            IceAndFire.sendMSGToServer(new MessageUpdateLectern(((TileEntityLectern)IceAndFire.PROXY.getRefrencedTE()).getBlockPos().asLong(), 0, 0, 0, true, page.ordinal()));
                        }
