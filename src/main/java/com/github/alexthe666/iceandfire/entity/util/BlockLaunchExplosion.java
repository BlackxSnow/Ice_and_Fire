...
public class BlockLaunchExplosion extends Explosion {
    ...
    public void explode() {
        ...
        for (int k2 = 0; k2 < list.size(); ++k2) {
            ...
            if (!entity.ignoreExplosion() &&(exploder == null || !entity.is(exploder))) {
                double d12 = Mth.sqrt(entity.distanceToSqr(Vector3d)) / f3;
                if (d12 <= 1.0D) {
        ...
        if (flag) {
            ...
            for (BlockPos blockpos : this.affectedBlockPositions) {
                ...
                if (!blockstate.isAir(this.world, blockpos)) {
                    ...
                    float f3 = this.size * 2.0F;
                    double d12 = Mth.sqrt(fallingBlockEntity.distanceToSqr(Vector3d)) / f3;
                    double d4 = this.x;
                    double d6 = this.y;
                    double d8 = this.z;
