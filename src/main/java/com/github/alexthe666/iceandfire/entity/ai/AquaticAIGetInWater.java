...
public class AquaticAIGetInWater extends Goal {
    ...
    public boolean canUse() {
        if (creature.isVehicle() || creature instanceof TamableAnimal && ((TamableAnimal) creature).isTame() || creature.isInWater() || isAttackerInWater() || creature instanceof EntitySiren && (((EntitySiren) creature).isSinging() || ((EntitySiren) creature).wantsToSing())) {
            return false;
        } else {
