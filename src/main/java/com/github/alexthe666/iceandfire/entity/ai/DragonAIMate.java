...
public class DragonAIMate extends Goal {
     ...
     */
    public void tick() {
        this.dragon.getLookControl().setLookAt(this.targetMate, 10.0F, (float) this.dragon.getMaxHeadXRot());
    ...
    private void spawnBaby() {
        ...
        if (egg != null) {
            Player PlayerEntity = this.dragon.getLoveCause();
            ...
            for (int i = 0; i < 17; ++i) {
                ...
                double d3 = random.nextDouble() * (double) this.dragon.getBbWidth() * 2.0D - (double) this.dragon.getBbWidth();
                double d4 = 0.5D + random.nextDouble() * (double) this.dragon.getBbHeight();
                double d5 = random.nextDouble() * (double) this.dragon.getBbWidth() * 2.0D - (double) this.dragon.getBbWidth();
