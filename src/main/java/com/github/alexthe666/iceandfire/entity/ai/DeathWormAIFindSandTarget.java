...
public class DeathWormAIFindSandTarget extends Goal {
    ...
    public boolean canUse() {
        ...
        if (this.mob.getRandom().nextFloat() < 0.5F) {
            ...
            if (path != null || !this.mob.getNavigation().isDone() && !isDirectPathBetweenPoints(this.mob, this.mob.position(), new Vec3(path.getEndNode().x, path.getEndNode().y, path.getEndNode().z))) {
