    ...
    public StymphalianBirdAIFlee(EntityStymphalianBird stymphalianBird, float avoidDistanceIn) {
        ...
        this.canBeSeenSelector = new Predicate<Entity>() {
            public boolean apply(@Nullable Entity entity) {
                return entity instanceof Player && entity.isAlive() && StymphalianBirdAIFlee.this.stymphalianBird.getSensing().canSee(entity) && !StymphalianBirdAIFlee.this.stymphalianBird.isAlliedTo(entity);
            }
        };
