...
public class EntityCyclops extends Monster implements IAnimatedEntity, IBlacklistedFromStatues, IVillagerFear, IHumanoid {
    ...
    public EntityCyclops(EntityType type, Level worldIn) {
        super(type, worldIn);
        this.maxUpStep = 2.5F;
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true, new Predicate<LivingEntity>() {
            ...
            public boolean apply(@Nullable LivingEntity entity) {
                return !EntityGorgon.isStoneMob(entity) && DragonUtils.isAlive(entity) && !(entity instanceof WaterAnimal) && (!(entity instanceof Player) || ((Player)entity).isCreative()) && !(entity instanceof EntityCyclops) && !ServerEvents.isSheep(entity) && !(entity instanceof Animal && !(entity instanceof Wolf || entity instanceof PolarBear || entity instanceof EntityDragonBase)) || entity instanceof EntityGorgon || entity instanceof AbstractVillager;
            }
        }));
    ...
    public boolean doHurtTarget(Entity entityIn) {
        ...
        if (attackDescision == 0) {
            ...
            if (!entityIn.hasPassenger(this) && entityIn.getBbWidth() < 1.95F && !(entityIn instanceof EntityDragonBase) && !entityIn.getType().is(IafTagRegistry.CYCLOPS_UNLIFTABLES)) {
